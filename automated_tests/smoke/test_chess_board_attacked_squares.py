...
test_data_dict = {
    "test_resource_1": {
        ...
        "expected_result": {
            True: ["a1", "a3", "b1", "c1", "c3", "d2", "d3", "d4", "d5", "d6", "d7", "d8", "e1", "e5", "f1", "f3",
                   "f5", "g1", "g2", "g3", "h1", "h5"],
            False: ["b4", "b5", "c5", "d5", "e1", "e2", "e3", "e4", "e6", "e7", "e8", "f5", "f7", "f8", "g5", "g7",
                    "h5", "h8"]
        }
    },
    "test_resource_2": {
    ...
    "test_resource_3": {
        ...
        "expected_result": {
            True: ["a3", "a4", "a7", "b1", "b3", "b4", "b5", "b6", "c1", "c2", "c5", "c7", "d2", "d4", "e1", "e2",
                   "e7", "f3", "f4", "f5", "f6", "g3", "g4", "g5", "h1", "h3", "h5", "h6"],
    ...
    "test_resource_5": {
        ...
        "expected_result": {
            True: ["a7", "b1", "b2", "b3", "b4", "b5", "b6", "b8", "c4", "c7", "c8", "d7", "e4", "e7", "e8", "f4",
                   "f5", "f7", "h5"],
            False: ["a2", "a4", "b1", "b2", "b5", "c2", "d1", "d2", "d5", "e1", "e3", "e4", "e5", "e6", "e7", "e8",
                    "f2", "f5", "g2", "g3", "g7", "g8", "h2", "h5"]
        }
    }
}
