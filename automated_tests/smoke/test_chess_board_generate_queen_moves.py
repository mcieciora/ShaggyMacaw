...
test_data_dict = {
    "test_resource_1": {
        ...
        "value": "Q",
        "position": (2, 1),
        "expected_result": ["c2b1", "c2c1", "c2d1", "c2d2", "c2c3", "c2b3", "c2a4", "c2b2"]
    },
    "test_resource_2": {
        "fen": "r1b1r1k1/1pb3p1/2nq1p2/2N3P1/pPRp3p/3N3P/P1Q1PPB1/5RK1 b - b3 4 23",
        "value": "q",
        "position": (3, 5),
        "expected_result": ["d6d7", "d6d8", "d6d5", "d6c5", "d6e7", "d6f7", "d6e5", "d6f4", "d6g3", "d6h2"]
    },
    "test_resource_3": {
        "fen": "4qk2/2r3bp/1p1pb1p1/p4r2/1nPPpn2/2NB3P/5NP1/R1BQK2R w KQ - 2 9",
        "value": "Q",
        "position": (3, 0),
        "expected_result": ["d1d2", "d1c2", "d1b3", "d1a4", "d1e2", "d1f3", "d1g4", "d1h5"]
    },
    "test_resource_4": {
        "fen": "4qk2/2r3bp/1p1pb1p1/p4r2/1nPPpn2/2NB3P/5NP1/R1BQK2R w KQ - 2 9",
        "value": "q",
...
@mark.skip("Skipped until queen movement is implemented.")
@mark.smoke
...
def test__smoke__chess_board__generate_queen_moves(test_key, test_data, expected_output):
    ...
    actual_result = test_object.generate_queen_moves(piece)
