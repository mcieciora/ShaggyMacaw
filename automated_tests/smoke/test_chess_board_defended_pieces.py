...
test_data_dict = {
    "test_resource_1": {
        ...
        "expected_result": {
            ...
            False: ["a7", "a8", "b6", "b8", "d7", "d8", "e7", "f6", "f7", "f8", "g6", "g7", "g8", "h7"]
        }
    },
    "test_resource_2": {
        ...
        "expected_result": {
            ...
            False: ["a7", "a8", "c5", "d6", "d8", "e5", "e6", "f6", "f7", "f8", "g6", "g7", "g8", "h7"]
        }
    },
    "test_resource_3": {
        "fen": "2rr2k1/pb2qpbp/5np1/2ppn3/8/1PN1P2P/PBQNBPP1/3RR1K1 w - - 0 18",
        "expected_result": {
            True: ["a2", "b2", "b3", "c3", "d1", "d2", "e1", "e2", "e3", "f2", "g1", "g2", "h3"],
            False: ["b7", "c5", "c8", "d5", "d8", "e5", "f6", "f7", "g6", "g7", "g8", "h7"]
        }
    },
    "test_resource_4": {
        "fen": "r3r1k1/pp3p1p/1bn5/6p1/3p1Nb1/6P1/PP1NPPBP/R1R2K2 w - g6 0 18",
        "expected_result": {
            True: ["a1", "a2", "c1", "e2", "f1", "f2", "f4", "g2", "g3"],
            False: ["a7", "a8", "b6", "c6", "d4", "e8", "f7", "g8", "h7"]
        }
    },
    "test_resource_5": {
...
def test__smoke__chess_board__defended_pieces(test_data, expected_output):
    ...
    for active_colour in expected_output:
        actual_data = test_object.get_defended_pieces(active_colour)
        assert actual_data == expected_output[active_colour], f"Expected: {expected_output}, actual: {actual_data}."
