                ...
                stage ("pylint") {
                    steps {
                        script {
                            ...
                            sh "docker run --rm test_image python -m pylint --load-plugins pylint_pytest automated_tests --max-line-length=120 --disable=C0114,C0116 --fail-under=10.0"
        ...
        stage ("Run tests") {
            matrix {
                axes {
                    axis {
                        name "TEST_GROUP"
                        values "fen", "chess_board", "evaluation"
                    }
                }
                stages {
                    stage ("Test stage") {
